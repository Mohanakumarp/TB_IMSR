...
export default function OtpScreen() {
  ...
  const onVerify = async () => {
    ...
    try {
        ...
        // This automatically stores the session (access_token + refresh_token) in AsyncStorage
        ...
        // NOTE: Do NOT pass sessionToken anymore. The backend should verify the token from the Authorization header,
        // which will be added by our apiClient.ts wrapper for all subsequent requests.
        ...
        const response = await fetch(`${BACKEND_URL}/api/auth/verify`, {
            ...
            body: JSON.stringify({ role, phone: formattedPhone, opid ,sessionToken: accessToken })
        });
